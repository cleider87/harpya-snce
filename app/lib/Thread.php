...
class Thread {
    ...
    private $errors = array(
        Thread::FUNCTION_NOT_CALLABLE   => 'Se debe seleccionar un método o función válida en este contexto',
        Thread::COULD_NOT_FORK          => 'pcntl_fork() Ha devuelto -1. No se pudo crear este proceso',
    );
    ...
    public function getError( $_code ) {
        if ( isset( $this->errors[$_code] ) ) {
            ...
            return 'Error código ' . $_code . '! Quit inventing errors!!!';
        }
    }
